...
const generateCode = (name: string): string => {
    ...
    return `DMH/PRM/${new Date().getFullYear()}/${initials}-${Math.floor(1000 + Math.random() * 9000)}`;
};
        ...
        return (
            ...
            >
                ...
                <div className="bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-600 px-8 py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-xl px-4 py-2 text-center">
                            <p className="text-sm font-black text-white">PROMOTION LETTER</p>
                        </div>
                    </div>
                </div>

                {/* Ref & Date */}
                <div className="px-8 py-2 bg-sky-50 border-b border-sky-200 flex justify-between text-xs">
                ...
                <div className="flex-1 px-8 py-4 flex flex-col">
                    ...
                    <div className="bg-sky-50 rounded-xl p-3 border border-sky-200 flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-slate-600">{data.currentDesignation} • {data.department} • ID: {data.employeeId}</p>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-green-400 to-emerald-500 rounded-lg p-4 text-center mb-3">
                        <p className="text-white text-lg font-black">CONGRATULATIONS!</p>
                        <p className="text-white/90 text-xs">On your well-deserved promotion</p>
                    </div>
                    ...
                    <div className="bg-slate-50 rounded-lg p-3 border border-slate-200 mb-3">
                        <h3 className="font-bold text-slate-800 mb-1 text-sm">New Responsibilities</h3>
                        <p className="text-xs text-slate-600">{data.newResponsibilities}</p>
                    </div>

                    <p className="text-slate-700 text-xs mb-3">
                        We appreciate your dedication and contributions to <strong>{data.companyName}</strong>. Keep up the excellent work!
                    </p>
