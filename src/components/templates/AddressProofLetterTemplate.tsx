...
export const AddressProofLetterTemplate = forwardRef<HTMLDivElement, AddressProofLetterTemplateProps>(
    ({ data }, ref) => {
        ...
        return (
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-slate-600 via-slate-700 to-slate-800 px-10 py-5">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-xl px-5 py-3 text-center">
                            <p className="text-base font-black text-white">ADDRESS</p>
                ...
                <div className="flex-1 px-10 py-5 flex flex-col">
                    ...
                    <div className="text-center mb-5">
                        ...
                        <div className="w-32 h-1 bg-gradient-to-r from-slate-500 to-slate-600 mx-auto mt-2 rounded-full"></div>
                    </div>
                    ...
                    <div className="bg-blue-50 rounded-xl p-5 border border-blue-200 mb-5">
                        <h3 className="font-bold text-blue-800 mb-2 text-lg">Residential Address (As per records)</h3>
