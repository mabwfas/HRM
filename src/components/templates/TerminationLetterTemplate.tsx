...
export const TerminationLetterTemplate = forwardRef<HTMLDivElement, TerminationLetterTemplateProps>(
    ({ data }, ref) => {
        ...
        return (
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-red-600 via-rose-600 to-pink-700 px-10 py-6">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-xl px-5 py-3 text-center">
                            <p className="text-lg font-black text-white">TERMINATION</p>
                ...
                {/* Ref & Date */}
                <div className="px-10 py-3 bg-red-50 border-b border-red-200 flex justify-between text-sm">
