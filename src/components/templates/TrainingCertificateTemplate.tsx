            ...
            >
                ...
                <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 px-5 py-2">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-indigo-100 text-[10px] italic">{data.companyTagline}</p>
                        </div>
                        <div className="bg-white/20 rounded px-2 py-1 text-center">
                            <p className="text-[10px] font-black text-white">TRAINING CERTIFICATE</p>
                        </div>
                    </div>
                </div>

                {/* Ref & Date */}
                <div className="px-5 py-0.5 bg-indigo-50 border-b border-indigo-100 flex justify-between text-[10px]">
                ...
                <div className="px-5 py-2 flex flex-col">
                    ...
                    <div className="text-center mb-2">
                        ...
                        <div className="w-16 h-0.5 bg-indigo-500 mx-auto mt-1 rounded-full"></div>
                    </div>

                    {/* Employee Card */}
                    <div className="bg-indigo-50 rounded p-1.5 border border-indigo-200 flex items-center gap-2 mb-2">
                        ...
                        <div>
                            <p className="font-bold text-indigo-800 text-sm">{data.employeeName || '[Employee Name]'}</p>
                            <p className="text-[10px] text-slate-600">{data.designation} • {data.department} • ID: {employeeId}</p>
                        </div>
                    </div>

                    {/* Certificate Text */}
                    <p className="text-slate-700 text-[10px] text-center mb-1.5">
                        This is to certify that the above-named employee has successfully completed:
                    </p>

                    {/* Training Program Card */}
                    <div className="bg-yellow-50 rounded p-2 border border-yellow-200 text-center mb-2">
                        <p className="text-base font-black text-amber-800">{data.trainingProgram}</p>
                        <p className="text-amber-600 text-[10px]">Duration: {data.trainingDuration}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-1.5 mb-2">
                        ...
                        <div className="bg-green-50 rounded p-1.5 border border-green-200 text-center">
                            <p className="text-[9px] text-green-600 font-semibold">Status</p>
                            <p className="font-bold text-green-800 text-[10px]">{data.completionStatus}</p>
                        </div>
                        <div className="bg-blue-50 rounded p-1.5 border border-blue-200 text-center">
                            <p className="text-[9px] text-blue-600 font-semibold">Trainer</p>
                ...
                {/* Footer */}
                <div className="bg-indigo-900 px-5 py-1 mt-auto">
