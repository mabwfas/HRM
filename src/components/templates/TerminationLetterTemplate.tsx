            ...
            >
                ...
                <div className="bg-gradient-to-r from-red-600 via-rose-600 to-pink-700 px-8 py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-lg px-4 py-2 text-center">
                            <p className="text-sm font-black text-white">TERMINATION</p>
                            <p className="text-xs font-bold text-red-100">LETTER</p>
                        </div>
                    </div>
                </div>

                {/* Ref & Date */}
                <div className="px-8 py-1.5 bg-red-50 border-b border-red-200 flex justify-between text-xs">
                ...
                <div className="flex-1 px-8 py-4 flex flex-col">
                    ...
                    <div className="bg-red-50 rounded-lg p-3 border border-red-200 mb-3">
                        ...
                        <p className="text-slate-700 text-xs">{data.terminationReason || '[Reason for termination]'}</p>
                    </div>
