...
export const TrainingCertificateTemplate = forwardRef<HTMLDivElement, TrainingCertificateTemplateProps>(
    ({ data }, ref) => {
        ...
        return (
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 px-10 py-6">
                ...
                {/* Ref & Date */}
                <div className="px-10 py-3 bg-indigo-50 border-b border-indigo-100 flex justify-between text-sm">
                ...
                <div className="flex-1 px-10 py-6 flex flex-col">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <div className="w-32 h-1 bg-gradient-to-r from-indigo-500 to-blue-500 mx-auto mt-3 rounded-full"></div>
                    </div>

                    {/* Employee Card */}
                    <div className="bg-indigo-50 rounded-2xl p-5 border border-indigo-200 flex items-center gap-5 mb-5">
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                    ...
                    {/* Certificate Text */}
                    <p className="text-slate-700 text-base text-center mb-5 leading-relaxed">
                        This is to certify that the above-named employee has successfully completed the training program:
                    </p>

                    {/* Training Program Card */}
                    <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-2xl p-6 border border-yellow-200 text-center mb-5">
