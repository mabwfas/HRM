...
export const PromotionLetterTemplate = forwardRef<HTMLDivElement, PromotionLetterTemplateProps>(
    ({ data }, ref) => {
        ...
        return (
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-600 px-10 py-5">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-xl px-5 py-3 text-center">
                            <p className="text-base font-black text-white">PROMOTION</p>
                ...
                <div className="flex-1 px-10 py-5 flex flex-col">
                    {/* Employee Info */}
                    <div className="bg-sky-50 rounded-xl p-4 border border-sky-200 flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-slate-600">{data.currentDesignation} • {data.department} • ID: {employeeId}</p>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-green-400 to-emerald-500 rounded-xl p-4 text-center mb-4">
                        <p className="text-white text-2xl font-black">CONGRATULATIONS!</p>
                        <p className="text-white/90">On your well-deserved promotion</p>
                    </div>

                    {/* Promotion Details */}
                    <div className="bg-purple-50 rounded-xl p-4 border border-purple-200 mb-4">
                        <h3 className="font-bold text-purple-800 mb-3 text-center">Promotion Details</h3>
                        <div className="flex items-center justify-between gap-4">
                            <div className="text-center flex-1 bg-white rounded-xl p-3">
                            ...
                            <div className="text-center flex-1 bg-purple-100 rounded-xl p-3 border-2 border-purple-300">
                                <p className="text-xs text-purple-500 uppercase font-semibold">New Role</p>
                                <p className="font-bold text-purple-700">{data.newDesignation}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-xl p-4 border border-green-200 mb-4">
                        <h3 className="font-bold text-green-800 mb-3 text-center">Compensation Revision</h3>
                        <div className="grid grid-cols-3 gap-3 items-center">
                            ...
                            <div className="text-center p-2 bg-green-100 rounded-xl border-2 border-green-300">
                    ...
                    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200 mb-4">
                        <h3 className="font-bold text-slate-800 mb-1">New Responsibilities</h3>
                        <p className="text-slate-600 text-sm">{data.newResponsibilities}</p>
                    </div>
