...
export const InternshipCompletionTemplate = forwardRef<HTMLDivElement, InternshipCompletionTemplateProps>(
    ({ data }, ref) => {
        ...
        return (
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-700 px-10 py-5">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-xl px-5 py-3 text-center">
                            <p className="text-base font-black text-white">INTERNSHIP</p>
                ...
                <div className="flex-1 px-10 py-5 flex flex-col">
                    ...
                    <div className="text-center mb-5">
                        ...
                        <div className="w-32 h-1 bg-gradient-to-r from-violet-500 to-purple-500 mx-auto mt-2 rounded-full"></div>
                    </div>

                    {/* Intern Card */}
                    <div className="bg-violet-50 rounded-xl p-5 border border-violet-200 flex items-center gap-5 mb-5">
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                            {data.internName?.charAt(0) || 'I'}
                        </div>
                        <div>
                            <p className="text-xl font-black text-violet-800">{data.internName || '[Intern Name]'}</p>
                            <p className="text-violet-600">{data.internshipRole}</p>
                    ...
                    <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-200 mb-5">
                        <div className="flex justify-between items-center">
                            <p>Performance: <strong className="text-emerald-700 text-lg">{data.performanceRating}</strong></p>
