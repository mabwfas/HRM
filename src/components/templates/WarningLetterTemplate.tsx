...
export const WarningLetterTemplate = forwardRef<HTMLDivElement, WarningLetterTemplateProps>(
    ({ data }, ref) => {
        ...
        return (
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-r from-orange-500 via-red-500 to-rose-600 px-10 py-5">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-xl px-5 py-3 text-center">
                            <p className="text-base font-black text-white">WARNING</p>
                ...
                <div className="flex-1 px-10 py-5 flex flex-col">
                    ...
                    <div className="bg-red-50 rounded-xl p-4 border border-red-200 mb-4">
                        <h3 className="font-bold text-red-800 mb-2">Incident Details</h3>
                    ...
                    <div className="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
                        ...
                        <p className="text-slate-700 text-sm">{data.expectedImprovement}</p>
                    </div>

                    {/* Consequences */}
                    <div className="bg-slate-800 rounded-xl p-4 text-white mb-4">
                        <h3 className="font-bold mb-2">Consequence if Not Improved</h3>
                        <p className="text-sm text-slate-200">{data.consequenceIfNotImproved}</p>
                    </div>
